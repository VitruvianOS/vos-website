...
Releases are available on the [Download](/download/) page. You can also build from source using the instructions in the [wiki](https://wiki.v-os.dev/docs/getting-started/building/).
